...
- **THEN** la API devuelve HTTP 200 con el detalle de la respuesta
- **AND** existe un registro en `responses` con `action_type='alerta'`, `actor='n8n-automated'` y `status='completed'` (o el correspondiente)
