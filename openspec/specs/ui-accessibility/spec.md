## Purpose
La aplicación web SHALL cumplir criterios de accesibilidad (WCAG): operabilidad por teclado, gestión de foco en overlays, anillo de foco consistente, respeto a `prefers-reduced-motion`, landmarks semánticos y contraste AA del texto secundario.
