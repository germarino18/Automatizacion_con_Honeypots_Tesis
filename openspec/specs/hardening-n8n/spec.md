...
Define el contrato de robustez y corrección de los workflows de automatización (n8n) del proyecto: consulta correcta de reputación en VirusTotal para PB-H2 y tolerancia a fallos transitorios de los nodos HTTP y Postgres críticos, de modo que la cadena de respuesta automática no se interrumpa.
