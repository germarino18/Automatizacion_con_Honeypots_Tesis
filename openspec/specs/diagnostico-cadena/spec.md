# Diagnóstico de Cadena

## Purpose

Define el contrato de verificación end-to-end de la cadena honeypot (Cowrie, Dionaea, n8n, PostgreSQL, Grafana y nginx) tras levantar el stack. Sirve como base de verificación para cambios futuros como `workflows-n8n` y el "puente Dionaea".
