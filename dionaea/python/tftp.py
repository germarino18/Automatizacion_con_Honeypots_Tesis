...
class TftpClient(TftpSession):
    ...
    def handle_established(self):
        ...
        # Fork 2 (Decisión 8): fix config()['downloads'] (formato LCFGX legacy, ya no existe)
        # → usar el formato GLib actual config()['dionaea']['download.dir'] (misma clave que store.py)
        download_dir = g_dionaea.config()['dionaea']['download.dir']
        self.fileobj = tempfile.NamedTemporaryFile(delete=False, prefix='tftp-', suffix='.tmp', dir=download_dir)
